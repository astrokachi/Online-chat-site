    ...
    <div className="transition-all ease-in duration-200">
      ...
      <section className="pt-2 text-white mx-auto ">
        <div className="md:pt-24 pt-44 pb-12 p-4 bg-opacity-40 rounded-md  bg-[#222222] text-sm">
          ...
          <p>
            Please review these terms and conditions of use carefully before using RSangels's websites, including,
...
You agree not to use any automated means, including robots, crawlers or data mining tools, to download, monitor or use data or Content from the Website;
          <br />
          <br />
You agree not to use the Website to collect usernames and/or email addresses for sending unsolicited messages of any kind;
          <br />
          <br />
...
You agree not to reverse engineer any portion of the Website.
          <br />
          <br />
You agree not to use a username of a hateful, racist, defamatory, ethnically offensive nature or any username related to children, terrorist organization and/or any other sites.
          <br />
          <br />
...
Models have the option to allow users to record their shows. Any recorded shows are for personal entertainment only. They are not for commercial or any other purpose.
          <br />
          <br />
...
A statement under penalty of perjury that you have a good faith belief that the material was removed or disabled as a result of mistake or misidentification of the material to be removed or disabled;
          <br />
          <br />
Your name, address, telephone number, email address and a statement that you consent to the jurisdiction of the courts in the address you provided, the Republic of Cyprus and the location(s) in which the purported copyright owner is located; and
          <br />
          <br />
...
We sometimes update, remove or add new things on our website. We do not always send notifications about these changes, so please read our detailed version of the Terms and Conditions.
          <br />
          <br />
